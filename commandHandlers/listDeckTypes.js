...
module.exports = async (interaction, args) => {
  try {
    ...
    if (!result || !result.length) {
      ...
      return await interaction.reply(errorEmbed.get(nws`Failed to get the list of decks. Please \
    ...
    return await interaction.reply(commonReplyEmbed.get('Available Deck Types:', text))
  } catch (error) {
